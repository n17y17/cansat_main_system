#ifndef SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_ARDUINO_EXAMPLE_HPP_
#define SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_ARDUINO_EXAMPLE_HPP_
...
void sc::save_log(const std::string &log)
{
    printf(log.c_str());
}

#endif  // SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_ARDUINO_EXAMPLE_HPP_