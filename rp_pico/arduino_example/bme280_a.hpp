#ifndef SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_BME280_A_HPP_
#define SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_BME280_A_HPP_
...
namespace sc
{
    ...
    class BME280 : public Sensor
    {
        ...
        void init(uint8_t select_device, Communication* i2c_or_spi);
    public:
        BME280() = default;
        ...
        void init(I2C* i2c, uint8_t slave_addr) {init(slave_addr, i2c);}
    ...
    private:
        ...
        int32_t _calibration_parameter;  // 気温，温度，湿度を補正する際に使用するパラメータ  (気温によって変わる)
        ...
        // 補正用のパラメータを計算
        void calc_calibration_parameter();
...
#endif  // SC_PROJECT_RP_PICO_PICO_SDK_ARDUINO_EXAMPLE_BME280_A_HPP_