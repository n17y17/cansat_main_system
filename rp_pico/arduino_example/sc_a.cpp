...
namespace sc
{
    ...
    Altitude0::Altitude0(const Pressure& pressure0, const Temperature& temperature0, const Altitude& altitude0)
    {
    ...
    Position0::Position0(const Latitude& latitude0, const Longitude& longitude0, const Altitude& altitude0)
    {
    ...
    Altitude to_altitude(const Pressure& pressure, const Temperature& temperature, const Pressure& pressure0, const Altitude& altitude0)
    {
    ...
    // [altitude0] : 基準点の気圧 (省略時:Altitude0でセットした標高)
    Altitude to_altitude(const Pressure& pressure, const Pressure& pressure0, const Temperature& temperature0, const Altitude& altitude0)
    {
    ...
    // [temperature0] : 基準点の気圧 (省略時:Altitude0でセットした気温)
    // [altitude0] : 基準点の気圧 (省略時:Altitude0でセットした標高)
    Altitude to_altitude(const Temperature& temperature, const Temperature& temperature0, const Altitude& altitude0)
    {
    ...
    Altitude to_altitude(const GravityAcceleration& gravity, const Magnitude& gravity0, const Altitude& altitude0)
    {
    ...
    A_Position to_position(const Latitude& latitude, const Longitude& longitude, const Altitude& altitude, const Latitude& latitude0, const Longitude& longitude0 , const Altitude& altitude0)
    {
    ...
    // [longitude0] : 原点の経度
    // [altitude0] : 原点の標高
    A_Position to_position_simple(const Latitude& latitude, const Longitude& longitude, const Altitude& altitude, const Latitude& latitude0, const Longitude& longitude0 , const Altitude& altitude0)
    {
        if (is_error({latitude, longitude, altitude, latitude0, longitude0, altitude0})) return A_Position(ErrorValue);
        A_Position output_position;
    ...
    Distance to_distance(const Latitude& latitude, const Longitude& longitude, const Latitude& latitude0, const Longitude& longitude0)
    {
        // 地球楕円体の表面上の距離を計算
        // 未実装
    ...
    // [latitude0] : 2つ目の位置の 緯度
    // [longitude0] : 2つ目の位置の 経度
    Distance to_distance_simple(const Latitude& latitude, const Longitude& longitude, const Latitude& latitude0, const Longitude& longitude0)
    {
