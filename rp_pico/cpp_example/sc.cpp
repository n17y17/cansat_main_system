...
namespace sc
{
    ...
    Altitude0::Altitude0(const Pressure& pressure0, const Temperature& temperature0, const Altitude& altitude0) noexcept
    {
    ...
    Altitude to_altitude(const GravityAcceleration& gravity, const Magnitude& gravity0, const Altitude& altitude0) noexcept
    {
