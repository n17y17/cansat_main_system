...
namespace sc
{
    ...
    // log : 書き込む文字列
    void save_log(const std::string& log) noexcept;
    ...
    public:
        ...
        Altitude0(const Pressure& pressure0, const Temperature& temperature0 = 25.0, const Altitude& altitude0 = 0.0) noexcept;
    ...
    Altitude to_altitude(const GravityAcceleration& gravity, const Magnitude& gravity0 = Earth_g, const Altitude& altitude = 0.0) noexcept;
